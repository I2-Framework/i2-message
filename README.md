...
> **Note:** the traditional way also exists `bus.subscribe(Message.class, new Subscriber() {...})` or more compactly using *lambda* expression `bus.subscribe(Message.class, System.out::println)`
